  ...
  describe 'POST /api/v1/documents' do
    ...
    context 'when successful' do
      ...
      it 'stores the appropriate fields in the Elasticsearch document' do
        ...
        expect(document.image_url).to eq('https://18f.gsa.gov/assets/img/logos/18F-Logo-M.png')
  ...
  describe 'PUT /api/v1/documents/{document_id}' do
    ...
    let(:update_params) do
      {
        ...
        image_url: 'https://18f.gsa.gov/assets/img/logos/new/18F-Logo-M.png',
        language: 'hy',
    ...
    context 'when successful' do
      ...
      it 'updates the document' do
        ...
        expect(document.image_url).to eq('https://18f.gsa.gov/assets/img/logos/new/18F-Logo-M.png')
